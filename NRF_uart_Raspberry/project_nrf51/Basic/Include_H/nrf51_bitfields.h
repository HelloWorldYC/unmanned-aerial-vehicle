...
/* Bits 15..8 : ADC analog pin selection. */   //ADC模拟引脚选择
#define ADC_CONFIG_PSEL_Pos (8UL) /*!< Position of PSEL field. */  //在寄存器设置的位置
...
#define ADC_CONFIG_PSEL_AnalogInput0 (1UL) /*!< Use analog input 0 as analog input. */  //模拟引脚为0
#define ADC_CONFIG_PSEL_AnalogInput1 (2UL) /*!< Use analog input 1 as analog input. */  //模拟引脚为1
#define ADC_CONFIG_PSEL_AnalogInput2 (4UL) /*!< Use analog input 2 as analog input. */   //模拟引脚为2
#define ADC_CONFIG_PSEL_AnalogInput3 (8UL) /*!< Use analog input 3 as analog input. */  //模拟引脚为3
#define ADC_CONFIG_PSEL_AnalogInput4 (16UL) /*!< Use analog input 4 as analog input. */  //模拟引脚为4
#define ADC_CONFIG_PSEL_AnalogInput5 (32UL) /*!< Use analog input 5 as analog input. */  //模拟引脚为5
#define ADC_CONFIG_PSEL_AnalogInput6 (64UL) /*!< Use analog input 6 as analog input. */  //模拟引脚为6
#define ADC_CONFIG_PSEL_AnalogInput7 (128UL) /*!< Use analog input 7 as analog input. */  //模拟引脚为7

/* Bits 6..5 : ADC reference selection. */   //参考电压的选择
#define ADC_CONFIG_REFSEL_Pos (5UL) /*!< Position of REFSEL field. */  //在寄存器设置的位置
#define ADC_CONFIG_REFSEL_Msk (0x3UL << ADC_CONFIG_REFSEL_Pos) /*!< Bit mask of REFSEL field. */
#define ADC_CONFIG_REFSEL_VBG (0x00UL) /*!< （内部1.2V VBG为参考电压的宏定义）  Use internal 1.2V bandgap voltage as reference for conversion. */
#define ADC_CONFIG_REFSEL_External (0x01UL) /*!< （外部AREF0,AREF1的输入电压为参考电压的宏定义） Use external source configured by EXTREFSEL as reference for conversion. */
#define ADC_CONFIG_REFSEL_SupplyOneHalfPrescaling (0x02UL) /*!< （VDD的1/2分压为参考电压的宏定义） Use supply voltage with 1/2 prescaling as reference for conversion. Only usable when supply voltage is between 1.7V and 2.6V. */
#define ADC_CONFIG_REFSEL_SupplyOneThirdPrescaling (0x03UL) /*!< （VDD的1/3分压为参考电压的宏定义） Use supply voltage with 1/3 prescaling as reference for conversion. Only usable when supply voltage is between 2.5V and 3.6V. */

/* Bits 4..2 : ADC input selection. */    //输入电压选择
#define ADC_CONFIG_INPSEL_Pos (2UL) /*!< Position of INPSEL field. */
#define ADC_CONFIG_INPSEL_Msk (0x7UL << ADC_CONFIG_INPSEL_Pos) /*!< Bit mask of INPSEL field. （INPSEL字段位置）*/ 
#define ADC_CONFIG_INPSEL_AnalogInputNoPrescaling (0x00UL) /*!<  （ADC外部管脚输入不分压的宏定义）  Analog input specified by PSEL with no prescaling used as input for the conversion. */
#define ADC_CONFIG_INPSEL_AnalogInputTwoThirdsPrescaling (0x01UL) /*!< （ADC外部管脚输入2/3分压的宏定义）  Analog input specified by PSEL with 2/3 prescaling used as input for the conversion. */
#define ADC_CONFIG_INPSEL_AnalogInputOneThirdPrescaling (0x02UL) /*!<  （ADC外部管脚输入1/3分压的宏定义） Analog input specified by PSEL with 1/3 prescaling used as input for the conversion. */
#define ADC_CONFIG_INPSEL_SupplyTwoThirdsPrescaling (0x05UL) /*!<  （VDD供电2/3分压的宏定义）  Supply voltage with 2/3 prescaling used as input for the conversion. */
#define ADC_CONFIG_INPSEL_SupplyOneThirdPrescaling (0x06UL) /*!<  （VDD供电1/3分压的宏定义）  Supply voltage with 1/3 prescaling used as input for the conversion. */

/* Bits 1..0 : ADC resolution.   ADC分辨率  */
#define ADC_CONFIG_RES_Pos (0UL) /*!< Position of RES field. */      //RES字段的位置
#define ADC_CONFIG_RES_Msk (0x3UL << ADC_CONFIG_RES_Pos) /*!< Bit mask of RES field. */   //RES字段的位掩码
#define ADC_CONFIG_RES_8bit (0x00UL) /*!< 8bit ADC resolution. */   //8位ADC分辨率（宏定义为0）
#define ADC_CONFIG_RES_9bit (0x01UL) /*!< 9bit ADC resolution. */     //9位ADC分辨率（宏定义为1）
#define ADC_CONFIG_RES_10bit (0x02UL) /*!< 10bit ADC resolution. */    //10位ADC分辨率（宏定义为2）
...
/* Bits 31..0 : UART baudrate. */    //UART波特率设置
#define UART_BAUDRATE_BAUDRATE_Pos (0UL) /*!< Position of BAUDRATE field. */  //波特率设置的位在寄存器中的位数
